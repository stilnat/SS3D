...
namespace SS3D.Systems.Animations
{
    public sealed class PickUpAnimation : AbstractProceduralAnimation
    {
        ...
        private void SetUpPickup(bool withTwoHands)
        {
            ...
            _mainHand.Hold.HandTargetFollowHold(false, _holdable);
        ...
        private void PickupReach(bool withTwoHands)
        {
            ...
            InteractionSequence.Join(DOTween.To(() => _mainHand.Hold.HoldIkConstraint.data.targetRotationWeight, x => _mainHand.Hold.HoldIkConstraint.data.targetRotationWeight = x, 1f, _itemReachDuration));
            ...
            if (withTwoHands)
            {
                InteractionSequence.Join(DOTween.To(() => _secondaryHand.Hold.HoldIkConstraint.data.targetRotationWeight, x => _secondaryHand.Hold.HoldIkConstraint.data.targetRotationWeight = x, 1f, _itemReachDuration));
